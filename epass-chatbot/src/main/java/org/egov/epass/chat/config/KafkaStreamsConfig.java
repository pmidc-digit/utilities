...
public class KafkaStreamsConfig {
    ...
    public void startStream(StreamsBuilder builder, Properties streamConfiguration) {
        final org.apache.kafka.streams.KafkaStreams streams = new KafkaStreams(builder.build(), streamConfiguration);
        streams.cleanUp();
        streams.start();
    ...
    private void initDefaultStreamConfiguration() {
        ...
        defaultStreamConfiguration.put(StreamsConfig.BOOTSTRAP_SERVERS_CONFIG, bootstrapAddress);
        ...
        defaultStreamConfiguration.put(StreamsConfig.NUM_STREAM_THREADS_CONFIG, kafkaConsumerThreads);
    }
