...
const Tradelicense = require('../../utils/TLcertificatie.json')
...
const customLoader = url => {
    ...
    const c = {
        ...
        "https://dev.digit.org/tradelicense" : Tradelicense
...
export const CertificateStatus = ({certificateData, goBack}) => {
    ...
    useEffect(() => {
        async function verifyData() {
            // console.log("verify Doc api called", (("\"" + certificateData + "\"")))
            try {
    ...
    return (
        <div className="certificate-status-wrapper">
            ...
            <h3 className="certificate-status">
                {
                    isValid ? "Trade License Certificate Successfully Verified" : "Trade License Certificate Invalid"
                }
            </h3>
            <br/>
            {
